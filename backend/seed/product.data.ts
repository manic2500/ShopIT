...
export const productsData = [
    {
        ...
        category: new Types.ObjectId("68f35dda24b2e034e402491d"), // Use the fixed ID for 'Electronics'
        seller: "Ebay",
        stock: 50,
        numOfReviews: 32,
        reviews: [],
    ...
    },
    {
        ...
        category: new Types.ObjectId("68f35dda24b2e034e4024922"), // Use the fixed ID for 'Headphones'
        seller: "Amazon",
        stock: 11,
        numOfReviews: 112,
        reviews: [],
    ...
    },
    {
        ...
        category: new Types.ObjectId("68f35dda24b2e034e4024920"), // Use the fixed ID for 'Accessories'
        seller: "Amazon",
        stock: 1123,
        numOfReviews: 6,
        reviews: [],
    },
    {
        ...
        category: new Types.ObjectId("68f35dda24b2e034e402491e"), // Use the fixed ID for 'Cameras'
        seller: "Amazon",
        stock: 131,
        numOfReviews: 222,
        reviews: [],
    },
    {
        ...
        category: new Types.ObjectId("68f35dda24b2e034e402491f"), // Use the fixed ID for 'Laptops'
        seller: "Amazon",
        stock: 0,
        numOfReviews: 56,
        reviews: [],
    },
    {
        ...
        category: new Types.ObjectId("68f35dda24b2e034e4024923"), // Use the fixed ID for 'Food'
